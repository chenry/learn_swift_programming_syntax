...
var someDictionary = ["Anchovies":false, "Coconut":true, "Cilantro":true, "Liver":false]
...
if let dogName = presidentialDogs["Barack Obama"] {
    
    print("Michele Obama walks \(dogName) every morning.")
