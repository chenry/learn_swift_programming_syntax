...
var charCount:Int = 0;
for currChar in howManyCharacters.characters {
    charCount = charCount + 1
}
let totalString = "Found: \(charCount) characters"
//: ### Exercise 4
...
var count = 0
for currChar in gString.characters {
    if currChar == "g" {
        count += 1
    }
}

let theGString = "Count of Gs is \(count)"
//: ### Exercise 5
...
var lottaLikesWithoutLikes = lottaLikes.stringByReplacingOccurrencesOfString("like", withString: "")
//: ### Exercise 7
// Example
